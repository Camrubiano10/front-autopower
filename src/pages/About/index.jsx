...
export default function About() {
  return (
    <>
      <div className="md:min-h-min md:py-[6.34%] flex flex-wrap items-center mt-12">
        <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
          <h3 className="text-3xl font-semibold leading-normal my-8 mt-auto">
            Sobre Nosotros
          </h3>
        ...
        <div className="max-w-full md:w-4/12 px-4 mr-auto ml-auto">
          <div className="relative flex flex-col break-words bg-white w-full mt-12 mb-10 shadow-lg rounded-lg">
            <img
              alt=""
              src={aboutImage}
              className="w-full my-auto align-middle rounded-t-lg"
            />
          </div>
        </div>
      </div>
